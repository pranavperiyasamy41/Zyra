...
const NotesPage: React.FC = () => {
  ...
  return (
    <div className="relative">
      {/* 📌 STICKY HEADER */}
      <div className="sticky top-0 z-20 backdrop-blur-md bg-white/80 dark:bg-slate-900/80 border-b border-gray-200 dark:border-slate-800 p-6 md:p-8 flex justify-between items-center transition-all">
        <div>
          <h1 className="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight">Manager's Notebook</h1>
          <p className="text-gray-500 text-sm">Reminders & To-Do List</p>
        </div>
        <button 
          onClick={() => setIsFormOpen(!isFormOpen)}
          className="bg-gray-900 text-white px-6 py-2 rounded-lg font-bold hover:bg-gray-800 transition-all shadow-lg active:scale-95"
        >
